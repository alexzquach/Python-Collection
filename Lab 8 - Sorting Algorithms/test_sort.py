...
if __name__ == "__main__":
    ...
    for algo_ in [quicksort_1, quicksort_2]:
        for i in range(1, 7):
            L = generate_data(i * 400, True, True)
            time_sort(L, sorted(L), algo_)
        L = generate_data(2000, True, True)
...
# selection_sort, insertion_sort_1, insertion_sort_2, bubblesort_1, bubblesort_2, mergesort_1, mergesort_2, quicksort_1,
